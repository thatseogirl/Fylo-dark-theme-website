  ...
  return (
    ...
    <div>
      <section className="introduction">
        ...
        <div className="introduction_text_container">
          ...
          <button className="introduction_text_container_heading_children_btn">Get Started</button>
        </div>
      </section>
          ...
          <div className="accessandsecurity_div_1">
            <section className="accessandsecurity_div">
              ...
              <p className="file_heading_body">
                ...
                your account means your files follow you everywhere.</p> 
                </div>
            </section>
    ...
    live collaboration. No email attachments required.</p>
          ...
          <section className="accessandsecurity_div">
              ...
              <p className="file_heading_body">
              2-factor authentication and user-controlled encryption are just a couple of
    the security features we allow to help secure your files.</p>
    </div>
            </section>
            <section className="store">
              <img
                src={file}
                alt="Store your files"
                className="img"
              />
               <div className="file">
    ...
    covered allowing for all file types to be securely stored and shared.</p>
    </div>
            </section>
          </div>
          </aside>
        ...
        <aside className="productive_section">
          ...
          <div className="productive_section_div">
            <h2 className="productive_section_div_header">Stay productive,<br /> wherever you are</h2>
